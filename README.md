...
客户端赞助地址： http://pay.wzhot.com/cs2.html 无需root权限非xposed框架；
...
## 最后一次更新 2019年04月07日11:35:36
  ...
  1. 最新版支付宝(10.1.60)已经支持h5唤醒支付，将支付宝二维码地址使用a标签href属性即可，之前的版本请按照 app/controller/order.js 第127行修改，注：目前可以唤醒的不用理会本次更新;
